...
import com.gagauz.dso.bytecode.SharedClassVisitor;
...
public class TestAsm extends ClassLoader implements Opcodes {
    ...
    protected synchronized Class<?> loadClass(final String name, final boolean resolve) throws ClassNotFoundException {
        ...
        try {
            ...
            FileOutputStream fos = new FileOutputStream(new File("r:/asm." + name));
            fos.write(b);
            fos.flush();
            fos.close();
        } catch (Exception e) {
...
class TraceFieldClassAdapter extends ClassAdapter implements Opcodes {
    ...
    public AnnotationVisitor visitAnnotation(String arg0, boolean arg1) {
        ...
        shared = Type.getType(arg0).getClassName().equals(SharedObject.class.getName());
        return av;
    }
